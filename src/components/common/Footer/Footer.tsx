...
export const Footer: React.FunctionComponent = () => {
  return (
    <footer className={`${styles.siteFooter} text-light`}>
      <div className='container'>
        <div className={styles.siteFooterInner}>
          <div className={`brand ${styles.footerBrand}`}>
            <a href='#'>
              <svg
                width='32'
                height='32'
              ...
              >
                ...
                <g fill='none' fillRule='evenodd'>
                  <mask id='logo-gradient-footer-c' fill='#fff'>
                    {/* <use
												xlink:href="#logo-gradient-footer-a"
											/> */}
                  </mask>
                  <use
                    fillOpacity='.32'
          ...
          <ul className={`${styles.footerLinks} ${styles.listReset}`}>
            {/* <li>
              <a href='mailto:sekaran.srinivaas@gmail.com'>Contact</a>
            </li>
            <li>
              <a href='#'>About us</a>
            </li>
          ...
          <ul className={`${styles.footerSocialLinks} ${styles.listReset}`}>
            ...
            <li>
              <a href='#'>
                <span className={styles.screenReaderText}>Google</span>
                <svg width='16' height='16' xmlns='http://www.w3.org/2000/svg'>
                  <path
